...
panic-attack a harassment-free experience for everyone, regardless of
...
. The panic-attack maintainers will review the report
...
The panic-attack maintainers will follow these guidelines in determining
consequences:
...
* Appeals are reviewed by a different panic-attack maintainers member
than the original
...
* Open a
https://github.com/hyperpolymath/panic-attack/discussions[Discussion]
