{
  description = "panic-attacker - {project-description}";
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            echo "🚀 panic-attacker development environment"
            echo "Language: rust"
            echo ""
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P panic-attacker.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/panic-attacker $out/bin/  # Rust
            # cp bin/panic-attacker $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/panic-attacker";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-panic-attacker" {
